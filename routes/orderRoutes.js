...
// Place order (public — customers don't have accounts)
router.post('/', async (req, res) => {
  try {
    ...
    const result = await pool.query(
      `INSERT INTO orders
        (customer, items, subtotal, total_savings, payment_method, payment_status,
         razorpay_payment_id, razorpay_order_id, razorpay_signature, created_at)
